...
music = pg.mixer.Sound('assets/audio/music_1.wav')
...
def display_data():
    # draw panel
    pg.draw.rect(screen, "pink", (c.SCREEN_WIDTH,
                                  0, c.SIDE_PANEL, c.SCREEN_HEIGHT))
...
fast_forward_button = Button(
    c.SCREEN_WIDTH + 50, 300, fast_forward_image, False)
...
while run:
    ...
    if game_over == False:
        ...
        draw_text(str(c.BUY_COST), text_font,
                  "grey100", c.SCREEN_WIDTH + 215, 135)
        ...
        if selected_turret:
            ...
            if selected_turret.upgrade_level < c.TURRET_LEVELS:
                ...
                draw_text(str(c.UPGRADE_COST), text_font,
                          "grey100", c.SCREEN_WIDTH + 215, 195)
